; Listing generated by Microsoft (R) Optimizing Compiler Version 16.00.30319.01 
	...
	TITLE	C:\Users\tdrol\documents\visual studio 2010\Projects\parking\detector\CameraFile.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	?getImagePath@CameraFile@@UAE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ ; CameraFile::getImagePath
EXTRN	__RTC_CheckEsp:PROC
EXTRN	__RTC_Shutdown:PROC
EXTRN	__RTC_InitBase:PROC
;	COMDAT rtc$TMZ
; File c:\users\tdrol\documents\visual studio 2010\projects\parking\detector\camerafile.cpp
rtc$TMZ	SEGMENT
...
rtc$IMZ	ENDS
;	COMDAT ?getImagePath@CameraFile@@UAE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ
_TEXT	SEGMENT
$T30911 = -212						; size = 4
_this$ = -8						; size = 4
___$ReturnUdt$ = 8					; size = 4
?getImagePath@CameraFile@@UAE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ PROC ; CameraFile::getImagePath, COMDAT
; _this$ = ecx
...
; 7    : 	return path;
	...
	mov	ecx, DWORD PTR $T30911[ebp]
	or	ecx, 1
	mov	DWORD PTR $T30911[ebp], ecx
...
; 8    : }
	...
	pop	ebp
	ret	4
?getImagePath@CameraFile@@UAE?AV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@XZ ENDP ; CameraFile::getImagePath
_TEXT	ENDS
PUBLIC	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
PUBLIC	?c_str@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QBEPBDXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::c_str
PUBLIC	??_C@_01KDCPPGHE@r?$AA@				; `string'
PUBLIC	__$ArrayPad$
PUBLIC	?isValid@CameraFile@@UAE_NXZ			; CameraFile::isValid
...
;	COMDAT xdata$x
xdata$x	SEGMENT
__unwindtable$?isValid@CameraFile@@UAE_NXZ DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?isValid@CameraFile@@UAE_NXZ$0
__ehfuncinfo$?isValid@CameraFile@@UAE_NXZ DD 019930522H
	DD	01H
	DD	FLAT:__unwindtable$?isValid@CameraFile@@UAE_NXZ
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	DD	00H
	DD	01H
; Function compile flags: /Odtp /RTCsu /ZI
xdata$x	ENDS
;	COMDAT ?isValid@CameraFile@@UAE_NXZ
_TEXT	SEGMENT
tv86 = -292						; size = 4
tv87 = -288						; size = 4
$T24472 = -280						; size = 32
...
__$EHRec$ = -12						; size = 12
?isValid@CameraFile@@UAE_NXZ PROC			; CameraFile::isValid, COMDAT
; _this$ = ecx
...
; 11   : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?isValid@CameraFile@@UAE_NXZ
...
; 14   : #ifdef _WIN32
; 15   : 	status = (fopen_s(&f, getImagePath().c_str(), "r") == 0);

	mov	esi, esp
	push	OFFSET ??_C@_01KDCPPGHE@r?$AA@
	mov	edi, esp
	lea	eax, DWORD PTR $T24472[ebp]
	push	eax
	...
	lea	ecx, DWORD PTR $T24472[ebp]
	call	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >

; 16   : #else
; 17   : 	status = ((f = fopen(getImagePath().c_str(), "r")) != 0);
; 18   : #endif
; 19   : 	fclose(f);
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?isValid@CameraFile@@UAE_NXZ$0:
	lea	ecx, DWORD PTR $T24472[ebp]
	jmp	??1?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@XZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::~basic_string<char,std::char_traits<char>,std::allocator<char> >
__ehhandler$?isValid@CameraFile@@UAE_NXZ:
	...
	xor	ecx, eax
	call	@__security_check_cookie@4
	mov	eax, OFFSET __ehfuncinfo$?isValid@CameraFile@@UAE_NXZ
	jmp	___CxxFrameHandler3
text$x	ENDS
?isValid@CameraFile@@UAE_NXZ ENDP			; CameraFile::isValid
...
; 1993 : 			_Elem *_Ptr = this->_Bx._Ptr;
	...
	mov	DWORD PTR __Ptr$26341[ebp], ecx
...
; 1995 : 				_Traits::copy(this->_Bx._Buf, _Ptr, _Newsize);
	...
	push	eax
	mov	ecx, DWORD PTR __Ptr$26341[ebp]
	push	ecx
...
; 1996 : 			this->_Alval.deallocate(_Ptr, this->_Myres + 1);
	...
	add	ecx, 1
	push	ecx
	mov	edx, DWORD PTR __Ptr$26341[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1118 : 			size_type _Newsize = this->_Mysize - _Count;
	...
	mov	ecx, DWORD PTR [eax+20]
	sub	ecx, DWORD PTR __Count$[ebp]
	mov	DWORD PTR __Newsize$27423[ebp], ecx

; 1119 : 			_Eos(_Newsize);

	mov	eax, DWORD PTR __Newsize$27423[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$LN1@erase:
...
; 1954 : 		_Traits::assign(_Myptr()[this->_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T31003[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T31003[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	push	0
	lea	ecx, DWORD PTR $T31063[ebp]
	call	??0bad_alloc@std@@QAE@PBD@Z		; std::bad_alloc::bad_alloc
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	eax, DWORD PTR $T31063[ebp]
	push	eax
	call	__CxxThrowException@8
$LN3@Allocate:
...
; 37   : 		_THROW_NCEE(bad_alloc, 0);
	...
	push	0
	lea	ecx, DWORD PTR $T31072[ebp]
	call	??0bad_alloc@std@@QAE@PBD@Z		; std::bad_alloc::bad_alloc
	push	OFFSET __TI2?AVbad_alloc@std@@
	lea	eax, DWORD PTR $T31072[ebp]
	push	eax
	call	__CxxThrowException@8
$LN3@Allocate@2:
...
; 202  : 		::new ((void _FARQ *)_Ptr) _Ty(_STD forward<_Ty>(_Val));
	...
	add	esp, 8
	mov	DWORD PTR $T31079[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T31079[ebp], 0
